...
/**
 *@类:GbuyOrderProductEntity
 *@作者:zhangdaihao
 *@E-mail:zhangdaiscott@163.com
 *@日期:2011-12-19 13:09:31
 */

@Entity
@Table(name ="t60_gbuy_order_product")
@SuppressWarnings("serial")
public class GbuyOrderProductEntity implements java.io.Serializable {
	...
	/**团购服务项目ID*/
	private java.lang.String gopProductObid;
	...
	/**
	 *方法: 取得gopProductObid
	 *@return: java.lang.String  gopProductObid
	 */
	@Column(name ="gop_product_obid")
	public java.lang.String getGopProductObid(){
		return this.gopProductObid;
	}

	/**
	 *方法: 设置gopProductObid
	 *@param: java.lang.String  gopProductObid
	 */
	public void setGopProductObid(java.lang.String gopProductObid){
		this.gopProductObid = gopProductObid;
	}
