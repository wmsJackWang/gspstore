...
public class JeecgOrderCustomEntity implements java.io.Serializable {
	...
	//update-begin author:gaoxingang for:加外键注解  date：20130315
	/**
	 *方法: 取得gorderObid
	 *@return: java.lang.String  gorderObid
	 */
	@Column(name ="gorder_obid")
	@JoinColumn(name="gorder_obid")
	public java.lang.String getGorderObid(){
		return this.gorderObid;
	}
	//update-end author:gaoxingang for:加外键注解  date：20130315
