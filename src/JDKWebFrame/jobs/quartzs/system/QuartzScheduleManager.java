package JDKWebFrame.jobs.quartzs.system;
...
//@Component("scheduleMgr")//单例模式维护系统定时任务管理器
public class QuartzScheduleManager {
	 private static  Scheduler scheduler=getScheduler();  
	    ...
	    private static Scheduler getScheduler() {  
	            SchedulerFactory sf = new StdSchedulerFactory();  //生成定时任务管理器的工厂
	            Scheduler scheduler=null;  
	            try {  
	                scheduler = sf.getScheduler();  //定时任务管理器
